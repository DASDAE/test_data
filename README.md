...
The following files are trimmed (but otherwise unmodified) excerpts from the Global DAS Month February 2023 contributions hosted on [PubDAS](https://doi.org/10.1785/0220220279) (CC-BY, see each contribution's ReadMe on PubDAS for details):
